...
void Menu_Staff_Course_Student(staff a[], int& idx);
...
void Menu_Staff_Course_Student(staff a[], int& idx) {
	...
	while (KeyPressed != 13) {
		...
		cout << setw(63) << "-ACADEMIC STAFF - COURSE - STUDENT-" << endl;
		cout << endl;

		{
			...
			cout << setw(width) << "|            |" << endl;
			SetColor(color, i[0]);
			cout << setw(width) << "|  __|  |__  |"; // 4
			SetColor(color, i[1]);
			cout << setw(width) << "|  ________  |";
			SetColor(color, i[2]);
			cout << setw(width) << "|            |";
			SetColor(color, i[3]);
			cout << setw(width) << "|            |" << endl;
			SetColor(color, i[0]);
			cout << setw(width) << "| |__    __| |"; // 5
			SetColor(color, i[1]);
			cout << setw(width) << "| |________| |";
			SetColor(color, i[2]);
			cout << setw(width) << "| [] ======= |";
			...
			cout << setw(width) << " ADD STUDENT  ";
			SetColor(color, i[1]);
			cout << setw(width) << "REMOVE STUDENT";
			SetColor(color, i[2]);
			cout << setw(width) << " VIEW STULIST ";
			SetColor(color, i[3]);
			cout << setw(width) << "     BACK     " << endl;
			SetColor(color, i[0]);
		}
	...
	if (ptr != 3) Menu_Staff_Course_Student(a, idx);
}
...
void Menu_Staff_AcaYear(staff a[], int& idx) {
	...
	while (KeyPressed != 13) {
		...
		cout << setw(59) << "-ACADEMIC STAFF - ACADEMIC YEAR-" << endl;
		cout << endl;
...

		{
			...
			cout << setw(width) << " ------------ " << endl;
			SetColor(color, i[0]);
			cout << setw(width) << "|  ______(+) |"; // 2.1
			SetColor(color, i[1]);
			cout << setw(width) << "|  ______(^) |"; // 2.2
			SetColor(color, i[2]);
			cout << setw(width) << "|  ______(-) |"; // 2.3
			SetColor(color, i[3]);
			cout << setw(width) << "|  ______(=) |" << endl;
			SetColor(color, i[0]);
			cout << setw(width) << "| |        | |"; // 3.1
			SetColor(color, i[1]);
			cout << setw(width) << "| |        | |"; // 3.2
			...
			cout << setw(width) << "| |  2019  | |"; // 5.1
			SetColor(color, i[1]);
			cout << setw(width) << "| |  2019  | |"; // 5.2
			SetColor(color, i[2]);
			cout << setw(width) << "| |  2019  | |"; // 5.3
			SetColor(color, i[3]);
			cout << setw(width) << "| |  2019  | |" << endl;
			SetColor(color, i[0]);
			cout << setw(width) << "| |  2020  | |"; // 6.1
			SetColor(color, i[1]);
			cout << setw(width) << "| |  2020  | |"; // 6.2
			SetColor(color, i[2]);
			cout << setw(width) << "| |  2020  | |"; // 6.3
			SetColor(color, i[3]);
			cout << setw(width) << "| |  2020  | |" << endl;
			SetColor(color, i[0]);
			cout << setw(width) << "| |________| |"; // 7.1
			SetColor(color, i[1]);
			cout << setw(width) << "| |________| |"; // 7.2
			SetColor(color, i[2]);
			cout << setw(width) << "| |________| |"; // 7.3
			SetColor(color, i[3]);
			cout << setw(width) << "| |________| |" << endl;
			SetColor(color, i[0]);
			cout << setw(width) << "|  ========  |"; // 8.1
			...
			cout << endl;
			SetColor(color, i[0]);
			cout << setw(width) << " ADD ACAYEAR  ";
			SetColor(color, i[1]);
			cout << setw(width) << "UPDATE ACAYEAR";
			SetColor(color, i[2]);
			cout << setw(width) << "DELETE ACAYEAR";
			SetColor(color, i[3]);
			cout << setw(width) << " VIEW ACAYEAR " << endl;
			SetColor(color, i[0]);
		}
		cout << endl;
		{
