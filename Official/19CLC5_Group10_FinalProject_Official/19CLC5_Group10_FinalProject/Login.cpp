...
void view_profile_student(student c[], int& idx)
{
	...
	for (int i = 0; i < 13; i++) {
		if (i % 2 == 0) {
			...
			if (i == 1) {
				cout << " Full Name  | " << c[idx].fullname;
				for (int j = 0; j < bsize - 15 - strlen(c[idx].fullname) - 1; j++) {
					cout << " ";
				}
				cout << "|";
			}
				...
				for (int j = 0; j < bsize - 15 - strlen(c[idx].dob) - 1; j++) {
					cout << " ";
				}
				cout << "|";
			}
			else if (i == 7) {
				cout << " Class      | " << c[idx].classname;
				for (int j = 0; j < bsize - 15 - strlen(c[idx].classname) - 1; j++) {
					cout << " ";
				}
				cout << "|";
			}
			else if (i == 5) {
				cout << " Student ID | " << c[idx].id;
				for (int j = 0; j < bsize - 23 - 1; j++) {
					cout << " ";
				}
				cout << "|";
			}
				...
				char gentemp[2][7] = { "Female", "Male" };
				cout << gentemp[c[idx].gender];
				for (int j = 0; j < bsize - 15 - strlen(gentemp[c[idx].gender]) - 1; j++) {
					cout << " ";
				}
				cout << "|";
			}
